...
public class GPUImageSharpenFilter extends GPUImageFilter {
    private static final String SHARPEN_VERTEX_SHADER =
    ...
    private static final String SHARPEN_FRAGMENT_SHADER =
    ...
    public GPUImageSharpenFilter(final float sharpness) {
        super(GPUImageFilterType.SHARPEN, SHARPEN_VERTEX_SHADER, SHARPEN_FRAGMENT_SHADER);
