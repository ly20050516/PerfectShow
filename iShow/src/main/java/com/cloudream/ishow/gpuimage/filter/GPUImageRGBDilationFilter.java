...
public class GPUImageRGBDilationFilter extends GPUImageTwoPassTextureSamplingFilter {
    ...
    private static final String VERTEX_SHADER_4 =
            "attribute vec4 position;\n" +
                    "attribute vec2 inputTextureCoordinate;\n" +
                    "\n" +
                    "uniform float texelWidthOffset;\n" +
    ...
    private static final String FRAGMENT_SHADER_2 =
            "precision highp float;\n" +
                    "\n" +
                    "varying vec2 centerTextureCoordinate;\n" +
                    "varying vec2 oneStepPositiveTextureCoordinate;\n" +
    ...
    private static final String FRAGMENT_SHADER_3 =
            "precision highp float;\n" +
                    "\n" +
                    "varying vec2 centerTextureCoordinate;\n" +
                    "varying vec2 oneStepPositiveTextureCoordinate;\n" +
    ...
    private static final String FRAGMENT_SHADER_4 =
            "precision highp float;\n" +
                    "\n" +
                    "varying vec2 centerTextureCoordinate;\n" +
                    "varying vec2 oneStepPositiveTextureCoordinate;\n" +
    ...
    private GPUImageRGBDilationFilter(String vertexShader, String fragmentShader) {
        ...
        setFilterType(GPUImageFilterType.RGB_DILATION);
    }
