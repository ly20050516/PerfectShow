...
public class GPUImageKuwaharaFilter extends GPUImageFilter {
    private static final String KUWAHARA_FRAGMENT_SHADER =
    ...
    public GPUImageKuwaharaFilter(int radius) {
        ...
        this.setFilterType(GPUImageFilterType.KUWAHARA);
        mRadius = radius;
    }
    ...
    /**
     * The radius to sample from when creating the brush-stroke effect, with a default of 3. The
     * larger the radius, the slower the filter.
     *
