...
public class GPUImageChromaKeyBlendFilter extends GPUImageTwoInputFilter {
    private static final String CHROMA_KEY_BLEND_FRAGMENT_SHADER =
    ...
    public GPUImageChromaKeyBlendFilter() {
        super(GPUImageFilterType.BLEND_CHROMA_KEY, CHROMA_KEY_BLEND_FRAGMENT_SHADER);
    }
    ...
    /**
     * The degree of smoothing controls how gradually similar colors are replaced in the image The
    ...
    /**
     * The threshold sensitivity controls how similar pixels need to be colored to be replaced The
