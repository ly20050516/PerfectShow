...
import com.cloudream.ishow.widget.CropImageView.BitmapCropCallback;
...
public class BitmapCropTask extends AsyncTask<Void, Void, Throwable> {
    ...
    private static final String TAG = BitmapCropTask.class.getSimpleName();
    ...
    private boolean crop(float resizeScale) throws IOException {
        ...
        if (shouldCrop) {
            boolean cropped = cropCImg(mImageInputPath, mImageOutputPath, left, top, width, height, mCurrentAngle,
                    resizeScale, mCompressFormat.ordinal(), mCompressQuality, mExifInfo.getExifDegrees(),
    ...
    native public boolean cropCImg(String inputPath, String outputPath, int left, int top, int width, int height,
                                   float angle, float resizeScale, int format, int quality, int exifDegrees, int exifTranslation)
