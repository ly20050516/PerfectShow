...
import com.cloudream.ishow.util.RotationGestureDetector;
...
public class GestureCropImageView extends CropImageView {
     ...
     * canceled. If it's ACTION_UP event - user removed all fingers from the screen and current
     * image position must be corrected. If there are more than 2 fingers - update focal point
     * coordinates. Pass the event to the gesture detectors if those are enabled.
     */
    @Override
    ...
    /**
     * This method calculates target scale value for double tap gesture. User is able to zoom the
     * image from min scale value to the max scale value with {@link #mDoubleTapScaleSteps} double
     * taps.
     */
