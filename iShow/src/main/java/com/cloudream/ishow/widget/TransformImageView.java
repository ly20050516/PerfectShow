...
import com.cloudream.ishow.util.BitmapLoadTask;
 ...
 * rotate), and methods to get current matrix state.
 */
public class TransformImageView extends ImageView {
    ...
    public void setTransformImageListener(@Nullable TransformImageListener transformImageListener) {
    ...
    public int getMaxBitmapSize() {
        if (mMaxBitmapSize <= 0)
            mMaxBitmapSize = BitmapUtils.calculateMaxBitmapSize(getContext());
    ...
    public void setImageUri(@NonNull Uri imageUri, @Nullable Uri outputUri) {
        ...
        BitmapUtils.decodeBitmapInBackground(getContext(), imageUri, outputUri, maxBitmapSize, maxBitmapSize,
                new BitmapLoadTask.BitmapLoadCallback() {
    ...
    /**
     * @return - current image scale value. [1.0f - for original image, 2.0f - for 200% scaled
     * image, etc.]
     */
     ...
     * {@link #mCurrentImageCorners} and {@link #mCurrentImageCenter} arrays. Those are used for
