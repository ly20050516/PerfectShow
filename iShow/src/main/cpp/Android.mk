...
PLATFORM_SOURCE := \
	$(THIS_PATH)/platform/com_cloudream_ishow_algorithm_Effect.cpp   \
	$(THIS_PATH)/platform/com_cloudream_ishow_algorithm_Feature.cpp  \
	$(THIS_PATH)/platform/com_cloudream_ishow_algorithm_Makeup.cpp   \
