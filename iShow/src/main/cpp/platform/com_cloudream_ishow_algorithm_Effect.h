...
#include <jni.h>
/* Header for class com_cloudream_ishow_algorithm_Effect */

#ifndef _Included_com_cloudream_ishow_algorithm_Effect
#define _Included_com_cloudream_ishow_algorithm_Effect
#ifdef __cplusplus
extern "C" {
#endif
#undef com_cloudream_ishow_algorithm_Effect_NATIVE
#define com_cloudream_ishow_algorithm_Effect_NATIVE 0L
/*
