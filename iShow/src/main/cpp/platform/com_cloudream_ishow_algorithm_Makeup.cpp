...
void JNICALL Java_com_cloudream_ishow_algorithm_Makeup_nativeApplyBrow(JNIEnv *env,
                                                                       jclass clazz, jobject _dst,
                                                                       jobject _src,
                                                                       jobjectArray _points,
                                                                       jobject _mask, jint _color,
                                                                       jfloat amount) {
    PROLOGUE_ENTER
...
void JNICALL Java_com_cloudream_ishow_algorithm_Makeup_nativeApplyEyeShadow(JNIEnv *env,
    ...
    for (jsize i = 0; i < N; ++i) {
        ...
        AndroidBitmapInfo mask_info;
        uint8_t *mask_pixels = reinterpret_cast<uint8_t *>(lockJavaBitmap(env, element_masks[i],
                                                                          mask_info));
