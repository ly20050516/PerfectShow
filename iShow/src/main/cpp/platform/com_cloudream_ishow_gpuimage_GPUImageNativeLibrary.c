...
Java_com_cloudream_ishow_gpuimage_GPUImageNativeLibrary_YUVtoRBGA(JNIEnv *env, jobject obj,
...
JNIEXPORT void JNICALL
Java_com_cloudream_ishow_gpuimage_GPUImageNativeLibrary_YUVtoARBG(JNIEnv *env, jobject obj,
                                                                  jbyteArray yuv420sp, jint width,
                                                                  jint height, jintArray rgbOut) {
    int sz;
    int i;
