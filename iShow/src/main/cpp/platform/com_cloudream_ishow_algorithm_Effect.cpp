...
void JNICALL Java_com_cloudream_ishow_algorithm_Effect_nativeApplyWhirlPinch
        (JNIEnv *env, jclass clazz, jobject _bitmap, jobject _pivot, jfloat whirl, jfloat pinch,
         jfloat radius) {
...
void JNICALL Java_com_cloudream_ishow_algorithm_Effect_nativeDistort
        (JNIEnv *env, jclass clazz, jobject _bitmap, jobject _point0, jobject _point1,
         jfloat strength, jint type) {
    AndroidBitmapInfo info;
    uint32_t *pixels = lockJavaBitmap(env, _bitmap, info);
    assert(pixels != nullptr);
/*
...
void JNICALL Java_com_cloudream_ishow_algorithm_Effect_nativeCatmullRomSpline
        (JNIEnv *env, jclass clazz, jobject _result, jfloat t, jobject _p0, jobject _p1,
         jobject _p2, jobject _p3) {
...
void JNICALL Java_com_cloudream_ishow_algorithm_Effect_nativeTone(JNIEnv *env,
                                                                  jclass clazz, jobject _bitmap,
                                                                  jint color, jfloat amount) {
...
void JNICALL
Java_com_cloudream_ishow_algorithm_Effect_nativeSelectContiguousRegionByColor(JNIEnv *env,
                                                                              jclass clazz,
                                                                              jobject _mask,
                                                                              jobject _image,
                                                                              jint _color,
                                                                              jint _select_criterion,
                                                                              jfloat threshold,
                                                                              jboolean antialias,
                                                                              jboolean select_transparent) {
