 ...
 */
    ...
    public:
        ...
        static cv::Mat resize(const cv::Mat &image, const cv::Point2f &pivot,
                              float left_scale, float top_scale, float right_scale,
                              float bottom_scale,
                              int interpolation = cv::INTER_LINEAR);

        static inline cv::Mat
        resize(const cv::Mat &image, const cv::Point2f &pivot, const cv::Vec4f &scale,
               int interpolation = cv::INTER_LINEAR) {
         ...
         */
        static void
        selectContiguousRegionByColor(cv::Mat &mask, const cv::Mat &image, const cv::Vec4b &color,
                                      uint8_t threshold,
                                      SelectCriterion criterion, bool select_transparent,
                                      bool antialias);

        static void
        selectContiguousRegionByColor(cv::Mat &mask, const cv::Mat &image, const cv::Vec4f &color,
                                      float threshold,
                                      SelectCriterion criterion, bool select_transparent,
                                      bool antialias);
        /**@}*/
        ...
        static void overlay(cv::Mat &dst, const cv::Mat &patch, const cv::Point2i &position,
                            const cv::Mat &mask);
         ...
         */
        static cv::Mat transform(cv::Size &size, cv::Point2f &pivot, const float &angle,
         ...
         */
        static void
        snake(const cv::Mat1f &image, std::vector<cv::Point2f> &points, float alpha, float beta,
