...
//	private:  // for internal use only
    ...
    private:
        ...
        createPolygon(const std::vector<cv::Point2f> &points, BlushShape shape, bool right);

    public:

        static std::vector<cv::Point2f>
        createHeartPolygon(const cv::Point2f &center, float radius, float angle = 0.0F);

        static cv::Mat
        createEyeShadow(cv::Mat mask[3], uint32_t color[3]/*, const int& COUNT = 3*/);
        ...
        /**@{*/
        static void
        blend(cv::Mat &result, const cv::Mat &dst, const cv::Mat &src, const cv::Point2i &origin,
              float amount);

        static void
        blend(cv::Mat &result, const cv::Mat &dst, const cv::Mat &src, const cv::Mat &mask,
         ...
         */
        static void
        applyBrow(cv::Mat &dst, const cv::Mat &src, const std::vector<cv::Point2f> &points,
         ...
         */
        static void
        applyEye(cv::Mat &dst, const cv::Mat &src, const std::vector<cv::Point2f> &points,
         ...
         */
        static void
        applyEyeLash(cv::Mat &dst, const cv::Mat &src, const std::vector<cv::Point2f> &points,
         ...
         */
        static void
        applyEyeShadow(cv::Mat &dst, const cv::Mat &src, const std::vector<cv::Point2f> &points,
         ...
         */
        static void
        applyIris(cv::Mat &dst, const cv::Mat &src, const std::vector<cv::Point2f> &points,
         ...
         */
        static void
        applyBlush(cv::Mat &dst, const cv::Mat &src, const std::vector<cv::Point2f> &points,
         ...
         */
        static void
        applyLip(cv::Mat &dst, const cv::Mat &src, const std::vector<cv::Point2f> &points,
