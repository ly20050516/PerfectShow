...
namespace venus {
    ...
    class Effect {
    private:
        static float mapColorBalance(float value, float lightness, float shadows, float midtones,
                                     float highlights);
    ...
    public:
        ...
        static void
        mapColor(cv::Mat &dst, const cv::Mat &src, const uint8_t *mask, const uint8_t table[256]);
        ...
        static inline void shade(cv::Mat &dst, const cv::Mat &src, float amount) {
            tone(dst, src, 0x00000000/* black */, amount);
        }

        static inline void tint(cv::Mat &dst, const cv::Mat &src, float amount) {
            tone(dst, src, 0x00FFFFFF/* white */, amount);
        }

        static inline void tone(cv::Mat &dst, const cv::Mat &src, uint32_t color) {
            tone(dst, src, color, (color >> 24) / 255.0F);
        }
        ...
        static inline void pixelize(cv::Mat &dst, const cv::Mat &src, int size) {
            pixelize(dst, src, size, size);
        }
         ...
         */
        static void
        colorize(cv::Mat &dst, const cv::Mat &src, float hue = 0.0F, float saturation = 0.5F,
         ...
         */
        static void
        unsharpMask(cv::Mat &dst, const cv::Mat &src, float radius = 5.0F, int threshold = 0,
                    float amount = 0.5F);
         ...
         */
        static void adjustColorBalance(cv::Mat &dst, const cv::Mat &src, const cv::Vec3f config[3],
         ...
         */
        static void
        adjustBrightnessAndContrast(cv::Mat &dst, const cv::Mat &src, float brightness = 0.0F,
                                    float contrast = 1.0F);
         ...
         */
        static void adjustHueSaturation(cv::Mat &dst, const cv::Mat &src, float hue = 0.0F,
